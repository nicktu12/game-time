...
class Game {
  ...
  continueToLevelTwo() {
    ...
    levelUpBtn.addEventListener('click', function() {
      buildAnArray = [ ...block.buildLevelTwoLeft(), ...block.buildLevelTwoRight() ];
      // buildAnArray.push(block.buildLevelTwoRight().split());
      // for (var r = 0; r < block.buildLevelTwoRight().length; r++) {
      //   buildAnArray.push(block.buildLevelTwoRight()[r]);
      // }
